...
🗣پیام ارسال شد");
        ...
        file_get_contents('https://api.telegram.org/bot'.$matches[1].'/setwebhook?url=http://milad5190-miladbot.44fs.preview.openshiftapps.com/'.$chat_id.'/Luncher.php');
...
";
     ...
     mkdir($id, 0700);
        ...
        file_get_contents('https://api.telegram.org/bot'.$text.'/setwebhook?url=http://milad5190-miladbot.44fs.preview.openshiftapps.com/'.$chat_id.'/Luncher.php');
...
.";
    ...
    $bot_url    = "https://api.telegram.org/bot267660853:AAEKgitoU1RjgPqEgL9_zbyFKDJ05-IFiBc/"; 
...
";
     ...
     mkdir($id, 0700);
        ...
        file_get_contents('https://api.telegram.org/bot'.$matches[0].'/setwebhook?url=http://milad-milad.44fs.preview.openshiftapps.com/'.$id.'/pvresan.php');
    $unstalled = "ربات شما با موفقیت نصب شده است🚀 
برای ورود به ربات خود کلیک کنید 👇😃
به ربات ما امتیاز بدید  👇
 https://telegram.me/storebot?start=pvresanbot
